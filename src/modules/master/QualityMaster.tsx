...
export default function QualityMaster() {
  ...
  const addItem = async (category: string) => {
    ...
    const list = category === 'rejectionReasons' ? rejectionReasons : inspectionTypes;
    ...
    if (category === 'rejectionReasons') {
      ...
      setInspectionTypes(updatedList);
    }

    await set(ref(database, `masters/quality/${category}`), updatedList);
    setNewItem('');
